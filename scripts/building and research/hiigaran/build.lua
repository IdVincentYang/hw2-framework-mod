...
build = 
  ...
  --      Description = "$7025", }, 
    { 
        Type = SubSystem, 
        ThingToBuild = "Hgn_C_Module_Power", 
        RequiredResearch = "", 
        RequiredShipSubSystems = "", 
        DisplayPriority = 180, 
        DisplayedName = "Reactor Module", 
        Description = "$7025", }, 
    { 
        Type = SubSystem, 
        ThingToBuild = "Hgn_MS_Module_Power", 
        RequiredResearch = "", 
        RequiredShipSubSystems = "", 
        DisplayPriority = 180, 
        DisplayedName = "Reactor Module", 
